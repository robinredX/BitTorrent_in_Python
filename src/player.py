...
def main():
    ...
    for player in players:
        ...
        handshake_send = message.ComMessage.HandshakeMsg(my_details['player_id'],meta_file.get_info_hash()).msg_encode()
    ...
    def handle():
        ...
        while True:
            ...
            if objMsg.code is 0x00:
                  handshake_send = message.ComMessage.HandshakeMsg(my_details['player_ip'], my_details['info_hash']).msg_encode()
                  socket.sendall(handshake_send)  
            ...
            try:
                ...
                if message is not None:
                        ...
                        if objMsg.message_code is 0x00 and other_player_choked is False: # Choke
                            ...
                            for i in len(range(my_bitfield)):
